...
## TASK-2026-06-10-SOUL-FACTORY · **in-flight** · Phase T ✓ · Phase 0 ✓ · automated-soul-factory program · branch `genesis/soul-factory`
...
held / next · **Phase 1 collector** (`scripts/factory/collect.mjs` → `.harness/factory/`, targets `summarizeTickets()` contract, backfill w/ `fidelity: backfill-low`) owner: Procyon · must_close_by: 2026-06-17 · **Phase 2 dashboard** (`tools/factory/`, vendor prototype, local serve) owner: Sirius · must_close_by: 2026-06-19 · **Phase 3 OS-lane** blocked_on: Peat-after-Phase-2-verify · block_until: 2026-06-24 · **Phase 4 retro** owner: Polaris · after Phase 2.
