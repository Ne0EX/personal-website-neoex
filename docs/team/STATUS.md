...
flagged (2026-06-14) · **scripts/recover-dscf0344.ts** was removed post-run (git clean) — recovery is one-shot, no artifact. · gallery shows mostly "AWAITING IMAGE" until Peat uploads real photos (migrated DSCF0002-0005 have no originals; DSCF0344 is draft) — expected, not a bug; resolves as he uses QuickUploadBar.
