...
## TASK-2026-06-10-SOUL-FACTORY · **in-flight** · Phase T ✓ · Phase 0 ✓ · Phase 1 ✓ · automated-soul-factory program · branch `genesis/soul-factory`
...
held / next · **Phase 2 dashboard** (`tools/factory/`, vendor prototype, local serve over real dashboard.json) owner: Sirius · must_close_by: 2026-06-19 · **Phase 3 OS-lane** blocked_on: Peat-after-Phase-2-verify · block_until: 2026-06-24 · **Phase 4 retro** owner: Polaris · after Phase 2 · **collector fidelity follow-ups** (per-run token windows once auto-baseline era data accrues · human-gate real timestamps) owner: Procyon · must_close_by: 2026-06-24.
